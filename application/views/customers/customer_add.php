                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add Data Customer</h3>
                        </div>
                        <!-- /.card-header -->

            <div class="card-body">
            <!-- form start -->
            <form action="<?=site_url('customer/action_add')?>" method="post" class="form-group" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" class="form-control">
                            ...
                            <option value="L" <?= set_value('gender') == 'L' ? "selected" : null?>>L</option>
                            <option value="P" <?= set_value('gender') == 'p' ? "selected" : null?>>P</option>
                        </select>
