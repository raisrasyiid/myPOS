            ...
            <form action="" method="post" class="form-group">
                <div class="card-body">
                    <div class="form-group <?=form_error('name') ? 'text-danger': null?>">
                        ...
                        <input type="text" name="name" value="<?= set_value('name')?>" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        <?= form_error('name')?>
                    </div>
                    <div class="form-group <?=form_error('username') ? 'text-danger': null?>">
                        ...
                        <input type="text" name="username" value="<?= set_value('username')?>" class="form-control" id="exampleInputPassword1" placeholder="Password">
                        <?= form_error('username')?>
                    </div>
