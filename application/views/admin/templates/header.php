...
<head>
    ...
    <title>MyPOS (Point Of Sale)</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
      <label class="h6 mb-0 text-gray-800">Anda login sebagai : <span class="text-danger"><?= ucfirst($this->session->userdata('username')) ?></span></label>
        </a>
      </li>
      </ul>
